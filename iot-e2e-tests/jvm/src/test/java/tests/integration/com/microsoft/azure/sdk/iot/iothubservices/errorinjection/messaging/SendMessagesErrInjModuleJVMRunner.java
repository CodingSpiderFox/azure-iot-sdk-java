...
public class SendMessagesErrInjModuleJVMRunner extends SendMessagesErrInjTests
{
    ...
    public SendMessagesErrInjModuleJVMRunner(InternalClient client, IotHubClientProtocol protocol, BaseDevice identity, AuthenticationType authenticationType, String clientType, String id, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
