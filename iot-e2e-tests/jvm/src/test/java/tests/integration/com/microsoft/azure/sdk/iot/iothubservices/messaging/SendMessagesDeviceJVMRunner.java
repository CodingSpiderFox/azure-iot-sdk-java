...
public class SendMessagesDeviceJVMRunner extends SendMessagesTests
{
    static Collection<BaseDevice> identities;

    public SendMessagesDeviceJVMRunner(InternalClient client, IotHubClientProtocol protocol, BaseDevice identity, AuthenticationType authenticationType, String clientType, String id, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
