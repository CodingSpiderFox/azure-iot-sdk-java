...
public class SendMessagesModuleJVMRunner extends SendMessagesTests
{
    ...
    public SendMessagesModuleJVMRunner(InternalClient client, IotHubClientProtocol protocol, BaseDevice identity, AuthenticationType authenticationType, String clientType, String id, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
